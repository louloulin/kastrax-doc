---
title: "Reference: Qdrant Vector Store | Vector Databases | RAG | Kastrax Docs"
description: Documentation for integrating Qdrant with Kastrax, a vector similarity search engine for managing vectors and payloads.
---
