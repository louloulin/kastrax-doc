---
title: "Reference: Pinecone Vector Store | Vector DBs | RAG | Kastrax Docs"
description: Documentation for the PineconeVector class in Kastrax, which provides an interface to Pinecone's vector database.
---
