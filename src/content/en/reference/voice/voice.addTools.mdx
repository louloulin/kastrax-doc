---
title: "Reference: voice.addTools() | Voice Providers | Kastrax Docs"
...
- Tools must follow the Kastrax tool format with name, description, input schema, and execute function
