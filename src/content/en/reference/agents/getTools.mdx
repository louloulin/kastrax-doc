---
title: "Reference: Agent.getTools() | Agents | Kastrax Docs"
description: "Documentation for the `.getTools()` method in Kastrax agents, which retrieves the tools that the agent can use."
---
