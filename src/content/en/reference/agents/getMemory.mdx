---
title: "Reference: Agent.getMemory() | Agents | Kastrax Docs"
description: "Documentation for the `.getMemory()` method in Kastrax agents, which retrieves the memory system associated with the agent."
---
