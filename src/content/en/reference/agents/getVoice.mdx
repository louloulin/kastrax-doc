---
title: "Reference: Agent.getVoice() | Agents | Kastrax Docs"
description: "Documentation for the `.getVoice()` method in Kastrax agents, which retrieves the voice provider for speech capabilities."
---
