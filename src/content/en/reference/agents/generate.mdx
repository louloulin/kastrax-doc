---
title: "Reference: Agent.generate() | Agents | Kastrax Docs"
description: "Documentation for the `.generate()` method in Kastrax agents, which produces text or structured responses."
---
