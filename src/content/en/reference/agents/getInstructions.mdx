---
title: "Reference: Agent.getInstructions() | Agents | Kastrax Docs"
description: "Documentation for the `.getInstructions()` method in Kastrax agents, which retrieves the instructions that guide the agent's behavior."
---
