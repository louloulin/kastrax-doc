...
The Telemetry API provides methods to retrieve and analyze traces from your Kastrax application. This helps you monitor and debug your application's behavior and performance.
