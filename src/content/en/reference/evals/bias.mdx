---
title: "Reference: Bias | Output Metrics | Evals | Kastrax Docs"
description: Documentation for the Bias Metric in Kastrax, which evaluates LLM outputs for various forms of bias, including gender, political, racial/ethnic, or geographical bias.
---
