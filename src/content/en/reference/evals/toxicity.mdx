---
title: "Reference: Toxicity | Metrics | Evals | Kastrax Docs"
description: Documentation for the Toxicity Metric in Kastrax, which evaluates LLM outputs for racist, biased, or toxic elements.
---
