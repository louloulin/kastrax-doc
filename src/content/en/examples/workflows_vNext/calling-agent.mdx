...
Register the planning agent and weather workflow with the kastrax instance.
...
<GithubLink
  link={
    "https://github.com/kastrax-ai/kastrax/blob/main/examples/basics/workflows/calling-agent"
  }
/>
