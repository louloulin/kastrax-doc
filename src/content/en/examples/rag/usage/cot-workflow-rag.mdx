---
title: "Example: Structured Reasoning with Workflows | RAG | Kastrax Docs"
description: Example of implementing structured reasoning in a RAG system using Kastrax's workflow capabilities.
---
...
const analyzeContext = new Step({
  ...
  execute: async ({ context, kastrax }) => {
    console.log("---------------------------");
    const ragAgent = kastrax?.getAgent('ragAgent');
...
<GithubLink
  link={
    "https://github.com/kastrax-ai/kastrax/blob/main/examples/basics/rag/cot-workflow-rag"
  }
/>
