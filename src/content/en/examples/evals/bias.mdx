---
title: "Example: Bias | Evals | Kastrax Docs"
...
This example demonstrates how to use Kastrax's Bias metric to evaluate responses for various forms of bias, including gender, age, and cultural bias.
...
import { BiasMetric } from '@kastrax/evals/llm';
```
...
<GithubLink
  link={
    "https://github.com/kastrax-ai/kastrax/blob/main/examples/basics/evals/bias"
  }
/>
