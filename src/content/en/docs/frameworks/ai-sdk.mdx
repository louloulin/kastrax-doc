...
- Works with the Kastrax REST API agent stream endpoint `{KASTRAX_BASE_URL}/agents/:agentId/stream` for data streams,
...
- Works with the Kastrax REST API agent stream endpoint `{KASTRAX_BASE_URL}/agents/:agentId/stream` for text streams,
