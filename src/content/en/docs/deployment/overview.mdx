...
description: Learn about different deployment options for your Kastrax applications
---
...
[View Kastrax Cloud documentation →](/docs/kastrax-cloud/overview)
...
| --- | --- | --- |
| **Kastrax Cloud** | Teams wanting to ship quickly without infrastructure concerns | Fully-managed, automatic scaling, built-in observability |
