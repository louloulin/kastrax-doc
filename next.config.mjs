...
export default withGT(
  withNextra({
    ...
    redirects: () => [
      ...
      {
        source: "/docs/local-dev/kastrax-init",
      ...
      },
      {
        ...
        destination: "/docs/local-dev/kastrax-dev",
        permanent: true,
      },
      {
      ...
      {
        source: "/docs/reference/storage/kastrax-storage",
        destination: "/reference/storage/libsql",
        permanent: true,
      },
      {
        source: "/docs/reference/tts/generate",
        destination: "/reference/voice/kastrax-voice",
        permanent: true,
      },
      {
